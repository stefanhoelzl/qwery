...
>
  ...
  >
    {#each tabs as name, idx (name)}
      <button
        ...
        class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 active focus:outline-hidden inline-flex snap-start items-center gap-x-2 whitespace-nowrap border-b-2 border-transparent px-1 py-2 text-sm text-gray-500 hover:text-blue-600 focus:text-blue-600 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-400 dark:hover:text-blue-500"
        id={`tabs-item-${id}-${idx}`}
  ...
  <button
    type="button"
    class="hs-scroll-nav-prev hs-scroll-nav-disabled:hidden hs-scroll-nav-disabled:pointer-events-none focus:outline-hidden absolute start-0 top-1/2 z-10 hidden size-9 shrink-0 -translate-y-1/2 items-center justify-center rounded-full bg-white text-gray-800 hover:bg-gray-100 focus:bg-gray-100 md:flex dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
  >
  ...
  <button
    type="button"
    class="hs-scroll-nav-next hs-scroll-nav-disabled:hidden hs-scroll-nav-disabled:pointer-events-none focus:outline-hidden absolute end-0 top-1/2 z-10 hidden size-9 shrink-0 -translate-y-1/2 items-center justify-center rounded-full bg-white text-gray-800 hover:bg-gray-100 focus:bg-gray-100 md:flex dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
  >
